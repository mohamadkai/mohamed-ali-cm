...
const faqs = [
  ...
  },
  {
    ...
    a: "البرنامج مش بيوعدك بوظيفة، لكنه بيبني المهارات والمخرجات اللي السوق بيدور عليها: Strategy، Copywriting، تحليل جمهور، استخدام AI بذكاء، Portfolio، وطريقة تعرض بيها نفسك لعميل أو شركة.",
  },
  {
