...
const faqs = [
  ...
  },
  {
    ...
    a: "المينتور شيب دا مش مجرد محاضرات لأنك خلال 3 شهورهتشتغل على مشاريع حقيقية في Strategy و Copywriting و AI و هتخرج ببورتفوليو يقول للسوق إنك جاهز وتكون مؤهل تشتغل في أي شركة أو حتى فريلانس",
  },
  {
