const bonuses = [
  ...
  desc: "سيشن فردية خاصة بعد المنتور شيب لمدة 40 دقيقة نراجع فيها تطورك وشغلك ونحدد لك الخطوة الجاية بناءً على مستواك .",
  encouragement: " هتخرج من المينتور شيب عارف أنت واقف فين وناقصك إيه والخطوة الجاية ليك .",
     value: "1500",
},
];
